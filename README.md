...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291824432.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291824432.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291824233.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291824233.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291824980.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291824980.png)


由于Session级别的一级缓存实际上就是使用PerpetualCache维护的，那么PerpetualCache是怎样实现的呢？


PerpetualCache实现原理其实很简单，其内部就是通过一个简单的`HashMap` 来实现的，没有其他的任何限制。如下是PerpetualCache的实现代码：
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825124.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825124.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825566.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825566.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825256.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825256.png)
...
刚才已经提到，Cache接口的实现，本质上是使用的`HashMap`,而构建CacheKey的目的就是为了作为`HashMap`中的key值。而HashMap是通过key值的hashcode 来组织和存储的，那么，构建CacheKey的过程实际上就是构造其hashCode的过程。下面的代码就是CacheKey的核心hashcode生成算法，感兴趣的话可以看一下：
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825752.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825752.png)


如图所示，当开一个会话时，一个SqlSession对象会使用一个Executor对象来完成会话操作，MyBatis的二级缓存机制的关键就是对这个Executor对象做文章。如果用户配置了"cacheEnabled\=true"，那么MyBatis在为SqlSession对象创建Executor对象时，会对Executor对象加上一个装饰者：CachingExecutor，这时SqlSession使用CachingExecutor对象来完成操作请求。CachingExecutor对于查询请求，会先判断该查询请求在Application级别的二级缓存中是否有缓存结果，如果有查询结果，则直接返回缓存结果；如果缓存中没有，再交给真正的Executor对象来完成查询操作，之后CachingExecutor会将真正Executor返回的查询结果放置到缓存中，然后在返回给用户。


[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825114.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825114.png)


CachingExecutor是Executor的装饰者，以增强Executor的功能，使其具有缓存查询的功能，这里用到了设计模式中的装饰者模式，CachingExecutor和Executor的接口的关系如下类图所示：


[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825381.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825381.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825471.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825471.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825613.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825613.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825419.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202404291825419.png)
...
[![](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202411301326512.png)](https://seven97-blog.oss-cn-hangzhou.aliyuncs.com/imgs/202411301326512.png)
...
**对于某些表执行了更新(update、delete、insert)操作后，去清空跟这些指定的表有关联的查询语句所造成的缓存**; 这样，就是以很细的粒度管理MyBatis内部的缓存，使得缓存的使用率和准确率都能大大地提升。
  ...
  * [一级缓存实现](#%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98%E5%AE%9E%E7%8E%B0)
* [什么是一级缓存？ 为什么使用一级缓存？](#%E4%BB%80%E4%B9%88%E6%98%AF%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98-%E4%B8%BA%E4%BB%80%E4%B9%88%E4%BD%BF%E7%94%A8%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98)
* [MyBatis中的一级缓存是怎样组织的？](#mybatis%E4%B8%AD%E7%9A%84%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98%E6%98%AF%E6%80%8E%E6%A0%B7%E7%BB%84%E7%BB%87%E7%9A%84)
* [一级缓存的生命周期有多长？](#%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E6%9C%89%E5%A4%9A%E9%95%BF):[悠兔机场官网订阅](https://5tutu.com)
* [SqlSession 一级缓存的工作流程](#sqlsession-%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E5%B7%A5%E4%BD%9C%E6%B5%81%E7%A8%8B)
* [Cache接口的设计以及CacheKey的定义](#cache%E6%8E%A5%E5%8F%A3%E7%9A%84%E8%AE%BE%E8%AE%A1%E4%BB%A5%E5%8F%8Acachekey%E7%9A%84%E5%AE%9A%E4%B9%89)
* [一级缓存的性能分析](#%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E6%80%A7%E8%83%BD%E5%88%86%E6%9E%90)
* [二级缓存实现](#%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E5%AE%9E%E7%8E%B0)
* [MyBatis的缓存机制整体设计以及二级缓存的工作模式](#mybatis%E7%9A%84%E7%BC%93%E5%AD%98%E6%9C%BA%E5%88%B6%E6%95%B4%E4%BD%93%E8%AE%BE%E8%AE%A1%E4%BB%A5%E5%8F%8A%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E5%B7%A5%E4%BD%9C%E6%A8%A1%E5%BC%8F)
* [MyBatis二级缓存的划分](#mybatis%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E5%88%92%E5%88%86)
* [使用二级缓存，必须要具备的条件](#%E4%BD%BF%E7%94%A8%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E5%BF%85%E9%A1%BB%E8%A6%81%E5%85%B7%E5%A4%87%E7%9A%84%E6%9D%A1%E4%BB%B6)
* [一级缓存和二级缓存的使用顺序](#%E4%B8%80%E7%BA%A7%E7%BC%93%E5%AD%98%E5%92%8C%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E4%BD%BF%E7%94%A8%E9%A1%BA%E5%BA%8F)
* [二级缓存实现的选择](#%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E5%AE%9E%E7%8E%B0%E7%9A%84%E9%80%89%E6%8B%A9)
* [MyBatis自身提供的二级缓存的实现](#mybatis%E8%87%AA%E8%BA%AB%E6%8F%90%E4%BE%9B%E7%9A%84%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E5%AE%9E%E7%8E%B0)
* [如何细粒度地控制二级缓存](#%E5%A6%82%E4%BD%95%E7%BB%86%E7%B2%92%E5%BA%A6%E5%9C%B0%E6%8E%A7%E5%88%B6%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98)
* [关于MyBatis的二级缓存的实际问题](#%E5%85%B3%E4%BA%8Emybatis%E7%9A%84%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E5%AE%9E%E9%99%85%E9%97%AE%E9%A2%98)
* [当前MyBatis二级缓存的工作机制](#%E5%BD%93%E5%89%8Dmybatis%E4%BA%8C%E7%BA%A7%E7%BC%93%E5%AD%98%E7%9A%84%E5%B7%A5%E4%BD%9C%E6%9C%BA%E5%88%B6)

   \_\_EOF\_\_

   ![](https://github.com/seven97-top)Seven  - **本文链接：** [https://github.com/seven97\-top/p/18666185](https://github.com)
 - **关于博主：** Seven的菜鸟成长之路
